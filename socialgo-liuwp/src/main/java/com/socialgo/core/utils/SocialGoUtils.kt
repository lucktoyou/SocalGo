package com.socialgo.core.utils
...
object SocialGoUtils {
    ...
    fun getFileProviderAuthority(context: Context): String {
        return context.packageName + ".socialfileprovider"
    }
            ...
            try {
                ...
                SocialGo.getHandler().post {
                    if (any != null) {
                        ...
                        callback.onFailure(SocialError(SocialError.CODE_DATA_PARSE_FAIL))
                    }
                }
            } catch (e: Exception) {
                SocialGo.getHandler().post {
                    callback.onFailure(SocialError(SocialError.CODE_EXCEPTION).append(e.toString()))
                }
            }
        }
    }
