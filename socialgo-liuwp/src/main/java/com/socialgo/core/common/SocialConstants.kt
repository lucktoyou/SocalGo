...
object SocialConstants {
    ...
    const val QQ_CREATOR = "com.socialgo.qq.QQPlatform\$Creator"
    const val WX_CREATOR = "com.socialgo.wechat.WxPlatform\$Creator"
    const val WB_CREATOR = "com.socialgo.weibo.WbPlatform\$Creator"
    const val ALI_CREATOR = "com.socialgo.alipay.AliPlatform\$Creator"

    const val QQ_PKG = "com.tencent.mobileqq"
    const val WX_PKG = "com.tencent.mm"
    const val WB_PKG = "com.sina.weibo"
    const val ALI_PKG = "com.eg.android.AlipayGphone"
     ...
     */
    const val WB_REDIRECT_URL = "https://api.weibo.com/oauth2/default.html"
